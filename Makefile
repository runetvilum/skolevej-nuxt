...
osm: clean
	mkdir -p osrm/osm
	$(OGR2OSM)ogr2osm.py -f -t osrm/translations/translation_vej.py -o osrm/osm/Skolevej_0-3.osm osrm/data/Skolevej_0-3_202105.geojson --id 100000
	$(OGR2OSM)ogr2osm.py -f -t osrm/translations/translation_vej.py -o osrm/osm/Skolevej_4-6.osm osrm/data/Skolevej_4-6_202105.geojson --id 100000
	$(OGR2OSM)ogr2osm.py -f -t osrm/translations/translation_vej.py -o osrm/osm/Skolevej_7-10.osm osrm/data/Skolevej_7-10_202105.geojson --id 100000
#	$(OGR2OSM)ogr2osm.py -f -t osrm/translations/translation_vej.py -o osrm/osm/Vejmidte.osm osrm/data/Skolevej_alle_Cykel_20170502.geojson --id 100000
